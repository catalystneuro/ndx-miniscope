# Next Steps for ndx-miniscope Extension for NWB:N

## Creating Your Extension

1. In a terminal, change directory into the new ndx-miniscope directory.
...
4. Modify `src/create_extension_spec.py` to define your extension.
    ...
    - If you want to create any custom classes for interacting with the extension,
      ...
      - If present, the `src/pynwb` folder MUST contain the following:
        - `ndx-miniscope` - Folder with the sources of the NWB extension
        - `ndx-miniscope/__init__.py` - Python file that may be empty
...
`spec/ndx-miniscope.namespace.yaml` and
`spec/ndx-miniscope.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-miniscope
...
`staged-extensions/ndx-miniscope`.

11. Edit `staged-extensions/ndx-miniscope/ndx-meta.yaml`
...
12. Edit `staged-extensions/ndx-miniscope/README.md`
to add information about your extension. You may copy it from
`ndx-miniscope/README.md`.
...
ndx-miniscope-feedstock will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-miniscope GitHub repository.

2. Publish your updated extension on PyPi.

3. Fork the ndx-miniscope-feedstock repository on GitHub.
