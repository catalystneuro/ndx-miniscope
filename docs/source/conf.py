...
# -*- coding: utf-8 -*-
#
# ndx-miniscope documentation build configuration file, created by
# sphinx-quickstart on Fri May 24 16:50:38 2019.
#
...
htmlhelp_basename = 'ndx-miniscopedoc'
...
latex_documents = [
    (master_doc, 'ndx-miniscope.tex', 'ndx-miniscope Documentation',
     'Ben Dichter', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndx-miniscope', 'ndx-miniscope Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndx-miniscope', 'ndx-miniscope Documentation',
     author, 'ndx-miniscope', 'One line description of project.',
     'Miscellaneous'),
]
